...
// A stray character in this key's JWT header once made every call from the
// browser answer 401 — including the session handover from the player — so
// it must stay byte-identical to SJ_SUPABASE_ANON_KEY in sj-admin-auth.ts.
